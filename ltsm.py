...
#The Dataframes in order to calculate final
results = pd.DataFrame([(0,0,0,0)], columns = ["MAE", "TS", "MSE", "RSFE"], index = ["100_1"]);
actual = pd.DataFrame([128, 119, 163, 148, 159, 137])
...
#test thoroughly
model1.compile(loss = MeanSquaredError(), optimizer = Adam(learning_rate = .0001),
