...
barplot(error_tables$MAE, names.arg = c("SMS", "Holt's", "A(5,3,2)", "A(0,1,1)", "Prophet", "KNN"), col = c(2,3,4,5,7), main = "Mean Absolute Error")

barplot(error_tables$TS, names.arg = c("SMS", "Holt's", "A(5,3,2)", "A(0,1,1)", "Prophet", "KNN"), col = c(2,3,4,5,7), main = "Tracking Signal")

barplot(error_tables$MSE, names.arg = c("SMS", "Holt's", "A(5,3,2)", "A(0,1,1)", "Prophet", "KNN"), col = c(2,3,4,5,7), main = "Mean Squared Error")

barplot(error_tables$RSFE, names.arg = c("SMS", "Holt's", "A(5,3,2)", "A(0,1,1)", "Prophet", "KNN"), col = c(2,3,4,5,7), main = "Running Sum of Error")
